...
class HighFrequencyStateTeltonikaResponse(BaseModel):
    ...
    rsrp: str | None = Field(None, alias=AliasPath("data", 0, "rsrp"))
    rsrq: str | None = Field(None, alias=AliasPath("data", 0, "rsrq"))
    sinr: str | None = Field(None, alias=AliasPath("data", 0, "sinr"))
    # Network Identifiers
    cell_id: str | None = Field(None, alias=AliasPath("data", 0, "cellid"))
    tracking_area_code: str | None = Field(None, alias=AliasPath("data", 0, "tac"))
    network_type: str | None = Field(None, alias=AliasPath("data", 0, "ntype"))
    frequency_band: str | None = Field(
        None, alias=AliasPath("data", 0, "cell_info", 0, "bandwidth")
    )
    ...
    physical_cell_id: str | None = Field(None, alias=AliasPath("data", 0, "cell_info", 0, "pcid"))
    operator: str | None = Field(None, alias=AliasPath("data", 0, "operator"))
    # Device Status
    modem_temperature: float | None = Field(None, alias=AliasPath("data", 0, "temperature"))
